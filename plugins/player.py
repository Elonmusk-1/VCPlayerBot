...
async def notforu(_, m: Message):
    k = await _.send_cached_media(chat_id=m.chat.id, file_id="CAADBQADEgQAAtMJyFVJOe6-VqYVzAI", caption="You Are Not Authorized", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton('⚡️Join Here', url='https://t.me/Class_9th_10th')]]))
    await delete_messages([m, k])
...
async def not_chat(_, m: Message):
    if m.from_user is not None and m.from_user.id in Config.SUDO:
        ...
        buttons = [
            [
                InlineKeyboardButton('⚡️Make Own Bot', url='https://t.me/Elonmusk_8'),
                InlineKeyboardButton('🧩 Join Here', url='https://t.me/class_9th_10th),
            ]
            ]
        await m.reply("<b>You can't use this bot in this group, for that you have to make your own bot.</b>")
